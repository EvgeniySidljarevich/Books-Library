...
export const Footer = () => {
    return (
        <FooterSection>
            <FooterContainer>
                <AboutColumn>
                    <h5>{titles.homePage.footer.about}</h5>
                    <ul>
                ...
                <HelpColumn>
                    <h5>{titles.homePage.footer.help}</h5>
                    <ul>
                ...
                <AccountColumn>
                    <h5>{titles.homePage.footer.account}</h5>
                    <ul>
                ...
                <ConnectionColumn>
                    <h5>{titles.homePage.footer.connection}</h5>
                    <ul>
                        <li>
                            <a href="/">
                                <svg
